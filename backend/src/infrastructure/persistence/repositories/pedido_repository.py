    ...
    def _model_to_entity(self, model: PedidoModel) -> PedidoMatricula:
        ...
        for aluno_model in model.alunos:
            aluno = Aluno(
                ...
                rg_data_emissao=aluno_model.rg_data_emissao,
                naturalidade=aluno_model.naturalidade,
                naturalidade_uf=aluno_model.naturalidade_uf,
                sexo=aluno_model.sexo,
                cor_raca=aluno_model.cor_raca,
                grau_instrucao=aluno_model.grau_instrucao,
                nome_pai=aluno_model.nome_pai,
                nome_mae=aluno_model.nome_mae,
        ...
        if existing:
            ...
            for aluno in pedido.alunos:
                aluno_model = AlunoModel(
                    ...
                    rg_uf=aluno.rg_uf,
                    rg_data_emissao=aluno.rg_data_emissao,
                    naturalidade=aluno.naturalidade,
                    naturalidade_uf=aluno.naturalidade_uf,
                    sexo=aluno.sexo,
                    cor_raca=aluno.cor_raca,
                    grau_instrucao=aluno.grau_instrucao,
