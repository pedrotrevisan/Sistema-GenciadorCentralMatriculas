"""Implementação do Repositório de Auditoria com SQLAlchemy/SQLite"""
...
class AuditoriaRepositorySQLite(IAuditoriaRepository):
    """Implementação concreta do repositório de auditoria usando SQLite"""
