"""Implementação do Repositório de Pedidos com SQLAlchemy/SQLite"""
...
class PedidoRepositorySQLite(IPedidoRepository):
    """Implementação concreta do repositório de pedidos usando SQLite"""
    ...
    async def salvar(self, pedido: PedidoMatricula) -> PedidoMatricula:
        ...
        if existing:
            ...
            # Update alunos - delete and recreate
