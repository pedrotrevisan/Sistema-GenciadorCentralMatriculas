...
from src.infrastructure.persistence.models import CursoModel, ProjetoModel, EmpresaModel, AlunoModel, TipoDocumentoModel, PendenciaModel, HistoricoContatoModel
